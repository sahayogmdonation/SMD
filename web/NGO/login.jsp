<%-- 
    Document   : login
    Created on : 03-Nov-2022, 4:56:24 pm
    Author     : Rahul
--%>
...
<html>
    <head>
       <meta charset="utf-8"/>
        ...
        <!-- Favicons -->
        <link href="Admin/assets/img/favicon.png" rel="icon" type="text/css"/>
        <link href="Admin/assets/img/apple-touch-icon.png" rel="apple-touch-icon" type="text/css"/>
...
<!--                    <p class="text-center small">Enter your username & password to login</p>-->
                  ...
                  <form class="row g-3 needs-validation" novalidate="">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="Ragistration.xhtml">Create an account</a></p>
                    </div>
                  </form>
