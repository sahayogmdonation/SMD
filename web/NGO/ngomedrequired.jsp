<%-- 
    Document   : ngomedrequired
    Created on : 03-Nov-2022, 4:57:36 pm
    Author     : Rahul
--%>
...
<html>
    <head>
       <meta charset="utf-8"/>
        ...
        <title>NGO required medicine</title>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="col-xl-6 card mb-12" style=" border-radius: 15px; box-shadow: 1px 1px  lightgray;">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Required Medicine</h5>
                    <p class="text-center small">Enter Required Medicine Detail</p>
                  </div>
                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                        <label for="inputNumber" class="col-sm-3
                                            col-form-label">Required quantity</label>
                                        <div class="col-sm-9">
                                            <input type="number"
                                                class="form-control"/>
                                        </div>
