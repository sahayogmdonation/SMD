<%-- 
    Document   : NGODashboard
    Created on : 03-Nov-2022, 4:53:47 pm
    Author     : Rahul
--%>
...
<html>
  ...
  <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link " href="NGODashboard.jsp">
...
<!--              <li class="nav-item">
                <a class="nav-link collapsed" href="NGO.xhtml">
...
<!--              <li class="nav-item">
                <a class="nav-link collapsed" href="Contact.xhtml">
...
<!--              <li class="nav-item">
                <a class="nav-link collapsed" href="Users.xhtml">
