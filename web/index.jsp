   ...
   <section id="hero"  class="d-flex align-items-center">
    ...
    <section id="Medicine" class="Medicine">   
        ...
        <div class="section-title">
         ...
         <div class="row">
         <div class="card mb-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="assets/img/departments-1.jpg" class="img-fluid rounded-start" alt="..."/>
              </div>
              <div class="col-md-8">
                <div class="card-body">
    ...
    </section> End Medicine View  Section -->


      <!-- Medicine card -->

      <section class="pt-5 pb-5" id="Medicines">
        <div class="container">
          <div class="row">
            <div class="col-7">
              <p class="mb-3 bl text-right">Medicines</p>
            </div>
     ...
     <div class="modal fade" id="fullscreenModal" tabindex="-1">
            ...
            <div class="col-xl-12 col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                         <img src="Admin/assets/img/logo.png" alt="" style="height:50px;width:auto"/>

               
                </a>
              </div><!-- End Logo -->

              <div class="col-xl-6 card mb-12" style=" border-radius: 15px; box-shadow: 1px 1px  lightgray;">

                  <div class="card-body " >

                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Donate Medicine</h5>
                    <p class="text-center small">Enter Medicine Details</p>
                  </div>
                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                        <label for="inputText" class="col-sm-3
                                            col-form-label">Medicine Name</label>
                                        <div class="col-sm-9">
                                            <input type="text"
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNumber" class="col-sm-3
                                            col-form-label">Medicine quantity</label>
                                        <div class="col-sm-9">
                                            <input type="number"
                                                class="form-control"/>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNumber" class="col-sm-3
                                            col-form-label">Medicine pic</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputDate" class="col-sm-3
                                            col-form-label">Donate Date</label>
                                        <div class="col-sm-9">
                                            <input type="date"
                                                class="form-control"/>
                                        </div>
      ...
      <section class="pt-5 pb-5" id="ngo">
        <div class="container">
          <div class="row">
            <div class="col-6">
              <p class="mb-3 bl text-right">NGO</p>
            </div>
