<%-- 
    Document   : index
    Created on : 03-Nov-2022, 9:36:05 am
    Author     : Rahul
--%>   
...
<html>
    ...
    <title>Sahayog Medicine Donation</title>
    <meta content="" name="description" />
    <meta content="" name="keywords" />

    <!-- Favicons -->
    <link href="Header/assets/img/logo.png" style="width:16px;height:16px" rel="icon" type="text/css" />
  ...
  <!-- ======= Header ======= -->
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        ...
        <a href="userregistration.jsp" class="appointment-btn scrollto"><span class="d-none d-md-inline">User Sign in</span></a>
        <a href="ngoreg.jsp" class="appointment-btn scrollto"><span class="d-none d-md-inline">NGO Sign in</span></a>
